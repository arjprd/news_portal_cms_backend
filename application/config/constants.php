...
define('BACKBONE_DATABASE_HOST', 'localhost');
define('BACKBONE_DATABASE_USER', 'root');
define('BACKBONE_DATABASE_PASSWORD', '');
define('BACKBONE_DATABASE_DATABASE', 'news_portal_backbone');

define('TEMP_DATABASE_HOST', 'localhost');
define('TEMP_DATABASE_USER', 'root');
define('TEMP_DATABASE_PASSWORD', '');
define('TEMP_DATABASE_DATABASE', 'news_portal_temp');
